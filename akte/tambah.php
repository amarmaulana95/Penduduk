...
<body>
    <div class="container">
	<form method="post" action="cetak.php" class="form-horizontal" role="form" novalidate>
		<table cellpadding="3" cellspacing="0">

		<div class="form-group">
			<label for="id_penduduk" class="col-sm-3 control-label">No KTP</label>
				<div class="col-sm-3">
				<input type="text" class="form-control" id="id_penduduk" name="id_penduduk" placeholder="isikan no ktp anda" required autofocus>
				</div>
		</div>
		...
		<div class="form-group">
			<label for="nama" class="col-sm-3 control-label">nik</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="nama" name="nik" placeholder="Nama Lengkap" required>
			</div>
		</div>
		<div class="form-group">
			<label for="nama" class="col-sm-3 control-label">No.kk</label>
			<div class="col-sm-3">
			<input type="text" class="form-control" id="nama" name="kk" placeholder="Nama Lengkap" required>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<select name="hubkel" class="form-control">
						<option value="Kepla Keluarga">Kepala Keluarga</option>
...
<script type="text/javascript">
 $(document).ready(function() {
  ...
  $("#cari").keyup(function() {
   ...
   <div class="form-group">
      <label for="desa" class="col-sm-3 control-label">Cari Berdasarkan KK</label>
        <div class="col-sm-3">
    	...
    	<div class="form-group">
			<label class="col-sm-3 control-label">PASPORT</label>
				<div class="col-sm-3">
					<input type="text" name="id_keluarga" class="form-control" required> 
				</div>
		</div>
...
<div class="form-group">
    	...
    	<div class="form-group">
			...
			<div class="col-sm-3">
			<input type="text" class="form-control" id="nama" name="statuspen" placeholder="Nama Lengkap" required>
			</div>
		</div>
