...
$result=mysql_query("SELECT * FROM ktp WHERE nik='$_GET[id]'") or die(mysql_error());
...
$column_statusktp = $column_statusktp.$statusktp. "\n";
}
...
$pdf->SetX(70);
$pdf->MultiCell(30,5,$column_statusktp,1,'C');
