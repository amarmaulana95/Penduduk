...
if ($row > 0) 
{
 ?>
            <div class="control-group">
              ...
              <div class="control-group">
                <label class="control-label" for="desa">ID Penduduk</label>
                  <div class="controls">
                    <input type="hidden" id="desa" name="id_penduduk" class="form-control" value="<?php echo $data['id_penduduk'] ?>">
                    <input type="text" id="desa" class="form-control" value="<?php echo $data['id_penduduk'] ?>" disabled>
                  </div>
        
              <div class="control-group">
                <label class="control-label" for="desa">Kelamin</label>
                  <div class="controls">
                    <input type="hidden" id="desa" name="j_kel" class="form-control" value="<?php echo $data['j_kel'] ?>">
                    <input type="text" id="desa" class="form-control" value="<?php echo $data['j_kel'] ?>" disabled>
                  </div>
              </div>
            
  
               <div class="control-group">
                <label class="control-label" for="desa">Pekerjaan</label>
                  <div class="controls">
                    <input type="hidden" id="desa" name="pekerjaan" class="form-control" value="<?php echo $data['pekerjaan'] ?>">
                    <input type="text" id="desa" class="form-control" value="<?php echo $data['pekerjaan'] ?>" disabled>
                  </div>
              </div>
              <div class="control-group">
